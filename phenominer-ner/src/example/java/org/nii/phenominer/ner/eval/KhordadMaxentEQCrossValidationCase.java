...
public class KhordadMaxentEQCrossValidationCase {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < numValidations; i++) {
			...
			Dictionary dict = loadDictionary("data/dictionary/hpo.txt");
			TokenNameFinder ruleFinder = new DictionaryNameFinder(dict);
			HybridApproximateEvaluator evaluator = new HybridApproximateEvaluator(new NameFinderME(nerModel),
					ruleFinder);
