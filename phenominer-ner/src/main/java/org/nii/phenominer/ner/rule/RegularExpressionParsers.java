...
public class RegularExpressionParsers {
	/**
	 * Regular expressions over words where sequences are string representations
	 * of words.
	 */
	public final static RegularExpressionParser<String> word = new RegularExpressionParser<String>() {
		@Override
		public BaseExpression<String> factory(final String string) {
	 ...
	 */
	public final static RegularExpressionParser<Character> character = new RegularExpressionParser<Character>() {
		@Override
		public BaseExpression<Character> factory(final String string) {
			return new BaseExpression<Character>(string) {
				@Override
				public boolean apply(final Character token) {
