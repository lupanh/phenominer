...
public class NERMaxentCrossValidator {
	String languageCode;
	...
	public NERMaxentCrossValidator(String languageCode, int cutoff, int iterations, AdaptiveFeatureGenerator featureGenerator) {
