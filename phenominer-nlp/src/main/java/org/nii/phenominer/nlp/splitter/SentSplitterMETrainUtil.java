...
public class SentSplitterMETrainUtil {
	...
	public static void trainSentenceDetectorModel() throws IOException {
		...
		OutputStream out = new FileOutputStream(SentSplitterMETrainUtil.class.getClassLoader().getResource("models/sentencesplitter/biosent.1.0.model").getFile());
