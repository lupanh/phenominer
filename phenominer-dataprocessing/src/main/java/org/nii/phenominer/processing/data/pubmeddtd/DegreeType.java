...
@XmlType(name = "degree.type", namespace = "http://www.w3.org/1998/Math/MathML", propOrder = {
    "degreeContent"
})
public class DegreeType {
    ...
    protected List<JAXBElement<?>> degreeContent;
    ...
    /**
     * Gets the value of the degreeContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the degreeContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDegreeContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getDegreeContent() {
        if (degreeContent == null) {
            degreeContent = new ArrayList<JAXBElement<?>>();
        }
