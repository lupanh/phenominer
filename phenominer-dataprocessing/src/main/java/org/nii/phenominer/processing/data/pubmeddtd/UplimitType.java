...
/**
 * <p>Java class for uplimit.type complex type.
 * 
...
@XmlType(name = "uplimit.type", namespace = "http://www.w3.org/1998/Math/MathML", propOrder = {
    "uplimitContent"
})
public class UplimitType {
    ...
    protected List<JAXBElement<?>> uplimitContent;
    ...
    /**
     * Gets the value of the uplimitContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the uplimitContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUplimitContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getUplimitContent() {
        if (uplimitContent == null) {
            uplimitContent = new ArrayList<JAXBElement<?>>();
        }
        return this.uplimitContent;
    }
