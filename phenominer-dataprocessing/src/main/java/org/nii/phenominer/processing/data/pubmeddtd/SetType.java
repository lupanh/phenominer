...
@XmlType(name = "set.type", namespace = "http://www.w3.org/1998/Math/MathML", propOrder = {
    "setContent"
})
public class SetType {
    ...
    protected List<JAXBElement<?>> setContent;
    ...
    /**
     * Gets the value of the setContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the setContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSetContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getSetContent() {
        if (setContent == null) {
            setContent = new ArrayList<JAXBElement<?>>();
        }
