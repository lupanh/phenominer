...
@XmlType(name = "declare.type", namespace = "http://www.w3.org/1998/Math/MathML", propOrder = {
    "declareContent"
})
public class DeclareType {
    ...
    protected List<JAXBElement<?>> declareContent;
    ...
    /**
     * Gets the value of the declareContent property.
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getDeclareContent() {
        if (declareContent == null) {
            declareContent = new ArrayList<JAXBElement<?>>();
        }
