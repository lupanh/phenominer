...
/**
 * <p>Java class for merror.type complex type.
 * 
...
@XmlType(name = "merror.type", namespace = "http://www.w3.org/1998/Math/MathML", propOrder = {
    "merrorContent"
})
public class MerrorType {
    ...
    protected List<JAXBElement<?>> merrorContent;
    ...
    /**
     * Gets the value of the merrorContent property.
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getMerrorContent() {
        if (merrorContent == null) {
            merrorContent = new ArrayList<JAXBElement<?>>();
        }
