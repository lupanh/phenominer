...
@XmlType(name = "mstyle.type", namespace = "http://www.w3.org/1998/Math/MathML", propOrder = {
    "mstyleContent"
})
public class MstyleType {
    ...
    protected List<JAXBElement<?>> mstyleContent;
    ...
    /**
     * Gets the value of the mstyleContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the mstyleContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMstyleContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getMstyleContent() {
        if (mstyleContent == null) {
            mstyleContent = new ArrayList<JAXBElement<?>>();
        }
