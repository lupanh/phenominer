...
@XmlType(name = "maction.type", namespace = "http://www.w3.org/1998/Math/MathML", propOrder = {
    "mactionContent"
})
public class MactionType {
    ...
    protected List<JAXBElement<?>> mactionContent;
    ...
    /**
     * Gets the value of the mactionContent property.
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getMactionContent() {
        if (mactionContent == null) {
            mactionContent = new ArrayList<JAXBElement<?>>();
        }
