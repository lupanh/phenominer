...
@XmlRootElement(name = "string-conf")
public class StringConf {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "conf-theme", type = ConfTheme.class),
        ...
        @XmlElementRef(name = "string-conf", type = StringConf.class),
        ...
        @XmlElementRef(name = "conf-acronym", type = ConfAcronym.class),
        ...
        @XmlElementRef(name = "conf-num", type = ConfNum.class),
