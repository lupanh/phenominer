...
/**
 * <p>Java class for list.type complex type.
 * 
...
@XmlType(name = "list.type", namespace = "http://www.w3.org/1998/Math/MathML", propOrder = {
    "listContent"
})
public class ListType {
    ...
    protected List<JAXBElement<?>> listContent;
     ...
     * 
     */
    public List<JAXBElement<?>> getListContent() {
        if (listContent == null) {
            listContent = new ArrayList<JAXBElement<?>>();
        }
