...
@XmlType(name = "piece.type", namespace = "http://www.w3.org/1998/Math/MathML", propOrder = {
    "pieceContent"
})
public class PieceType {
    ...
    protected List<JAXBElement<?>> pieceContent;

    /**
     * Gets the value of the pieceContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pieceContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPieceContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getPieceContent() {
        if (pieceContent == null) {
            pieceContent = new ArrayList<JAXBElement<?>>();
        }
