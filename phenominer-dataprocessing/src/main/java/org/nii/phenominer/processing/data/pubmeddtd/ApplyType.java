...
@XmlType(name = "apply.type", namespace = "http://www.w3.org/1998/Math/MathML", propOrder = {
    "applyContent"
})
public class ApplyType {
    ...
    protected List<JAXBElement<?>> applyContent;
    ...
    /**
     * Gets the value of the applyContent property.
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getApplyContent() {
        if (applyContent == null) {
            applyContent = new ArrayList<JAXBElement<?>>();
        }
